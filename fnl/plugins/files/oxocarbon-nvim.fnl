...
{1 :nyoom-engineering/oxocarbon.nvim
 ...
 :config (fn []
           ...
           (local color_error "#fa4d56") ;           (vim.api.nvim_set_hl 0 "FzfLuaScrollFloatEmpty"   {:fg "#d0d0d0" :bg "#262626"})
           ...
           (vim.api.nvim_set_hl 0 "NotifyERRORTitle" {:fg color_error}) ; Alerts ; Diff removes
           ...
           (vim.api.nvim_set_hl 0 "WhichKeyIconRed" {:fg "#ee5396"}) ;            (vim.api.nvim_set_hl 0 "@org.headline.level1" {:fg "#ff7eb6" :bold true :underline false})
           ...
           (vim.api.nvim_set_hl 0 "@org.headline.level1"
                                {:fg "#ff7eb6" :bold true :underline false})
           (vim.api.nvim_set_hl 0 "@org.headline.level2"
                                {:fg "#ffafd2" :bold true :underline false})
           (vim.api.nvim_set_hl 0 "@org.headline.level3"
                                {:fg "#ffd6e8" :bold true :underline false})
           (vim.api.nvim_set_hl 0 "@org.headline.level4"
                                {:fg "#fff0f7" :bold true :underline false})
           ...
           (vim.api.nvim_set_hl 0 "@org.priority.highest" {:fg color_error}) ;            (vim.api.nvim_set_hl 0 "@org.priority.high" {:fg "#fddc69"})
           (vim.api.nvim_set_hl 0 "@org.priority.default" {:fg color_warn}) ;            (vim.api.nvim_set_hl 0 "@org.priority.low" {:fg "#525252"})
